...
//검색 / page 두가지 경우 모두 Form 전송을 위해 JavaScrpt 이용  
	...
	$(function() {
		...
		//==> 1 과 3 방법 조합 : $("tagName.className:filter함수") 사용함. 
		 ...
		 $(".ct_list_pop .cart").on("click", function(){
	         var prodNo = $(this).data("param")
	         self.location="/cart/addCart?prodNo="+prodNo
	      });
	 });
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<c:forEach var="product" items="${list}">
		...
		<c:if test = "${product.prodAmount > 0 }">
		<td></td>
		<td class="cart" align="center" data-param="${product.prodNo }">
		<!-- ////////////////// jQuery Event 처리로 변경됨 /////////////////////////
		<a href="/cart/addCart?prodNo=${product.prodNo}"><i class="fas fa-shopping-cart"></i></a>
		///////////////////////////////////////////////////////////////////////////-->
